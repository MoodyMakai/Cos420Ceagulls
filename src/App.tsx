...
function App() {
  ...
  return (
    ...
    <div style={{ 
      ...
      top: 0,
      left: 0,
      width: '100%', // Optional: to make it span the entire width
      height: 'auto' // Optional: or set a specific height
    }}>
          ...
          <div className='row'>
            ...
            <div className='row'>
              ...
              <table id='myDIV' className='col-3 table' style={{ display: 'none' }}>
                    <tr>
                      <th>#</th>
                      <th>User Name</th>
                      <th>High Score</th>
